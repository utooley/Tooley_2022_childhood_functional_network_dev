...
datadir=fullfile('/data/picsl/mackey_group/BPD/CBPD_bids/derivatives/xcpEngine_gsr_spkreg_fd0.5dvars1.75_drpvls/')
...
%average whole system segregation, from Micaela Chan 2018 code
...
%Within and between connectivity, adapted from Micaela Chan 2018 code
Ci=yeo_nodes;
nCi = unique(Ci);
M=subfcmat;
